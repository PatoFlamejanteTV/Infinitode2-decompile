...
/*  47 */       for (int i = 0, j = param1FloatChannel.data.length; i < j; i += param1FloatChannel.strideSize) {
/*  48 */         param1FloatChannel.data[i] = 0.0F;
/*  49 */         param1FloatChannel.data[i + 1] = 0.0F;
/*  50 */         param1FloatChannel.data[i + 2] = 1.0F;
/*  51 */         param1FloatChannel.data[i + 3] = 1.0F;
/*  52 */         param1FloatChannel.data[i + 4] = 0.5F;
/*  53 */         param1FloatChannel.data[i + 5] = 0.5F;
/*     */       } 
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public void init(ParallelArray.FloatChannel param1FloatChannel) {
/*  68 */       Arrays.fill(param1FloatChannel.data, 0, param1FloatChannel.data.length, 1.0F);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public void init(ParallelArray.FloatChannel param1FloatChannel) {
/*  82 */       Arrays.fill(param1FloatChannel.data, 0, param1FloatChannel.data.length, 1.0F);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public void init(ParallelArray.FloatChannel param1FloatChannel) {
/*  96 */       for (int i = 0, j = param1FloatChannel.data.length; i < j; i += param1FloatChannel.strideSize) {
/*  97 */         param1FloatChannel.data[i] = 1.0F;
/*  98 */         param1FloatChannel.data[i + 1] = 0.0F;
/*     */       } 
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public void init(ParallelArray.FloatChannel param1FloatChannel) {
/* 113 */       for (int i = 0, j = param1FloatChannel.data.length; i < j; i += param1FloatChannel.strideSize) {
/* 114 */         param1FloatChannel.data[i + 2] = 0.0F; param1FloatChannel.data[i + 1] = 0.0F; param1FloatChannel.data[i] = 0.0F;
/*     */         
/* 116 */         param1FloatChannel.data[i + 3] = 1.0F;
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\badlogic\gdx\graphics\g3d\particles\ParticleChannels.class
