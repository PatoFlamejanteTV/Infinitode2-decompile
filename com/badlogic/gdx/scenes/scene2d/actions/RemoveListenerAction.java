...
/* 29 */     if (this.capture) {
/* 30 */       this.target.removeCaptureListener(this.listener);
/*    */     } else {
/* 32 */       this.target.removeListener(this.listener);
/* 33 */     }  return true;
/*    */   }
/*    */   
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\badlogic\gdx\scenes\scene2d\actions\RemoveListenerAction.class
