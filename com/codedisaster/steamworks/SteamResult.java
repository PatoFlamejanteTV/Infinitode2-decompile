...
/* 141 */     this.code = paramInt1;
/*     */   }
/*     */   
/*     */   public static SteamResult byValue(int paramInt) {
/* 145 */     if (paramInt < valuesLookupTable.length) {
/* 146 */       return valuesLookupTable[paramInt];
/*     */     }
...
/*     */   
/*     */   static {
/* 153 */     SteamResult[] arrayOfSteamResult1 = values();
/* 154 */     int i = 0; SteamResult[] arrayOfSteamResult2; int j;
/*     */     byte b;
/* 156 */     for (j = (arrayOfSteamResult2 = arrayOfSteamResult1).length, b = 0; b < j; ) { SteamResult steamResult = arrayOfSteamResult2[b];
/* 157 */       i = Math.max(i, steamResult.code);
/*     */       b++; }
/*     */     
/* 160 */     valuesLookupTable = new SteamResult[i + 1];
/*     */     
/* 162 */     for (j = (arrayOfSteamResult2 = arrayOfSteamResult1).length, b = 0; b < j; ) { SteamResult steamResult = arrayOfSteamResult2[b];
/* 163 */       valuesLookupTable[steamResult.code] = steamResult;
/*     */       b++; }
/*     */   
/*     */   }
/*     */ }
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\codedisaster\steamworks\SteamResult.class
