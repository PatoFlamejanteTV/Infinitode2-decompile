...
/*    */   
/*    */   public CustomTowerButtonAction(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
/* 22 */     this.x = paramInt1;
/* 23 */     this.y = paramInt2;
...
/*    */   }
/*    */   
/*    */   public CustomTowerButtonAction(JsonValue paramJsonValue) {
...
/* 68 */     return "CustomTowerButton " + this.x + " " + this.y + " " + this.mapX + " " + this.mapY;
/*    */   }
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\actions\CustomTowerButtonAction.class
