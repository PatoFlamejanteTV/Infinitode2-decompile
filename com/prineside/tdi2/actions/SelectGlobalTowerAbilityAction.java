...
/*    */   
/*    */   public SelectGlobalTowerAbilityAction(int paramInt1, int paramInt2, int paramInt3) {
/* 21 */     this.abilityIndex = paramInt1;
/* 22 */     this.x = paramInt2;
/* 23 */     this.y = paramInt3;
/*    */   }
/*    */   
/*    */   public SelectGlobalTowerAbilityAction(JsonValue paramJsonValue) {
...
/* 62 */     return "SelectGlobalTowerAbility " + this.x + " " + this.y + " " + this.abilityIndex;
/*    */   }
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\actions\SelectGlobalTowerAbilityAction.class
