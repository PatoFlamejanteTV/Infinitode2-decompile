...
/*     */ 
/*     */ @REGS
/*     */ public final class TowersAttackSpeed
...
/*  59 */     return (Drawable)Game.i.assetManager.getQuad("gpMods.TowersAttackSpeed");
/*     */   }
/*     */ 
/*     */   
/*     */   public final CharSequence getDescription() {
/*  64 */     String str = StringFormatter.compactNumberWithPrecisionTrimZeros((this.a + this.b * this.power), 1, true).toString();
/*  65 */     return Game.i.localeManager.i18n.format("gmod_descr_towers_attack_speed", new Object[] { str });
/*     */   }
/*     */ 
/*     */   
/*     */   public final TowersAttackSpeed cpy() {
/*  70 */     TowersAttackSpeed towersAttackSpeed = new TowersAttackSpeed();
/*  71 */     a(towersAttackSpeed);
/*  72 */     towersAttackSpeed.a = this.a;
/*  73 */     towersAttackSpeed.b = this.b;
/*  74 */     return towersAttackSpeed;
/*     */   }
/*     */   
...
/*  84 */     if ((activeMod = paramGameSystemProvider.gameplayMod.getActiveModFromSource(TowersAttackSpeed.class, paramString)) == null) {
/*     */       
...
/*     */ 
/*     */   
/*     */   public final TowersAttackSpeed applyConfig(JsonValue paramJsonValue) {
...
/* 111 */     if (this.d == null) {
/* 112 */       this.d = new GameValueSystem.GlobalTowerStatMutator("TowersAttackSpeedGMOD", f);
/* 113 */       this.c.gameValue.addGlobalTowerStatMutator(TowerStatType.ATTACK_SPEED, this.d); return;
/*     */     } 
...
/* 138 */       JsonValue jsonValue = param1BonusStagesConfig.getBonusConfig("TowersAttackSpeed");
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */ 
/*     */       
/* 147 */       if ((probableBonus = ProbableBonusesProvider.addOrModify((new TowersAttackSpeed()).applyConfig(jsonValue), param1Int, param1Array, (new ProbableBonusesProvider.BonusProviderConfig(0.5F)).setPowerUpProbabilityMultiplier(0.8F).applyConfig(jsonValue))) != null)
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\gameplayMods\mods\TowersAttackSpeed.class
