...
/* 46 */     setRegion(paramTextureRegionDrawable.a);
/*    */   }
/*    */   
/*    */   public void draw(Batch paramBatch, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4) {
/* 50 */     paramBatch.draw(this.a, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
/*    */   }
/*    */ 
/*    */   
...
/* 55 */     paramBatch.draw(this.a, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramFloat5, paramFloat6, paramFloat7, paramFloat8, paramFloat9);
/*    */   }
/*    */   
/*    */   public void setRegion(TextureRegion paramTextureRegion) {
/* 59 */     this.a = paramTextureRegion;
...
/*    */     Sprite sprite;
/* 73 */     if (this.a instanceof TextureAtlas.AtlasRegion) {
/* 74 */       TextureAtlas.AtlasSprite atlasSprite = new TextureAtlas.AtlasSprite((TextureAtlas.AtlasRegion)this.a);
/*    */     } else {
/* 76 */       sprite = new Sprite(this.a);
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\scene2\\utils\TextureRegionDrawable.class
