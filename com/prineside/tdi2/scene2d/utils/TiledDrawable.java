...
/*     */ {
/*  29 */   private final Color a = new Color(1.0F, 1.0F, 1.0F, 1.0F);
/*  30 */   private float b = 1.0F;
/*  31 */   private int c = 12;
/*     */ 
/*     */ 
/*     */ 
...
/*  47 */     paramBatch.setColor(paramBatch.getColor().mul(this.a));
/*     */     
/*  49 */     draw(paramBatch, getRegion(), paramFloat1, paramFloat2, paramFloat3, paramFloat4, this.b, this.c);
/*     */     
...
/* 290 */     (tiledDrawable = new TiledDrawable(this)).a.set(paramColor);
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\scene2\\utils\TiledDrawable.class
