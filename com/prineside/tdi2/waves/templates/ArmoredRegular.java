...
/*    */         }
/*    */         
/* 18 */         public EnemyType getEnemyType() { return EnemyType.REGULAR; }
...
/* 21 */         public float getHealth(int param1Int, float param1Float1, float param1Float2) { return 9.0F + (float)StrictMath.pow(param1Float2 * 10.0D, 1.27D) * 0.05F; }
...
/*    */       {
/*    */         private static float a(int param1Int) {
/* 31 */           return MathUtils.clamp(0.4F + param1Int / 20.0F * 0.6F, 0.0F, 1.0F);
/*    */         }
/*    */         private float b(int param1Int) {
/* 34 */           return 1.0F / a(param1Int);
/*    */         }
/*    */         
/* 37 */         public EnemyType getEnemyType() { return EnemyType.ARMORED; }
/* 38 */         public float getInterval(int param1Int, float param1Float1, float param1Float2) { return 1.1F * b(param1Int); }
/* 39 */         public int getCount(int param1Int, float param1Float1, float param1Float2) { return (int)((4 + (int)StrictMath.pow((param1Int * 0.9F), 0.52D)) * a(param1Int)); }
/* 40 */         public float getHealth(int param1Int, float param1Float1, float param1Float2) { return 17.0F + (float)StrictMath.pow(param1Float2 * 10.0D, 1.23D) * 0.09F; }
...
/* 51 */     return WaveTemplates.calculateProbability(paramInt, paramFloat2, 3, 0.08F, 0.6F, 0.35F, -55.0F, 25.0F, 0.1F, 4);
/*    */   }
/*    */   
...
/* 61 */     return "ArmoredRegular";
/*    */   }
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\waves\templates\ArmoredRegular.class
