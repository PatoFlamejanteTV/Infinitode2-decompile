...
/* 20 */         public int getCount(int param1Int, float param1Float1, float param1Float2) { return (int)((11.4F + (int)StrictMath.pow(param1Int, 0.63D)) * a(param1Int)); }
/* 21 */         public float getHealth(int param1Int, float param1Float1, float param1Float2) { return 9.9F + (float)StrictMath.pow(param1Float2 * 10.0D, 1.28D) * 0.045F; }
...
/* 32 */     return WaveTemplates.calculateProbability(paramInt, paramFloat2, 3, 0.06F, 0.5F, 0.22F, -65.0F, 40.0F, 0.11F, 7);
/*    */   }
/*    */   
...
/* 42 */     return "FastMedium";
/*    */   }
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\waves\templates\FastMedium.class
