...
/* 20 */         public int getCount(int param1Int, float param1Float1, float param1Float2) { return (int)(((4 + (int)StrictMath.pow(param1Int * 0.9D, 0.59D)) * a(param1Int)) * 0.8D); }
/* 21 */         public float getHealth(int param1Int, float param1Float1, float param1Float2) { return 19.0F + (float)StrictMath.pow(param1Float2 * 8.0D, 1.26D) * 0.098F; }
...
/* 32 */     return WaveTemplates.calculateProbability(paramInt, paramFloat2, 3, 0.07F, 0.5F, 0.33F, -44.0F, 20.0F, 0.11F, 4);
/*    */   }
/*    */   
...
/* 42 */     return "FighterLow";
/*    */   }
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\waves\templates\FighterLow.class
