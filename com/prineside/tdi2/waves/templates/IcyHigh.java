...
/* 19 */         public float getInterval(int param1Int, float param1Float1, float param1Float2) { return 0.32F * b(param1Int); }
/* 20 */         public int getCount(int param1Int, float param1Float1, float param1Float2) { return (int)((15 + (int)StrictMath.pow(param1Int, 0.68D)) * a(param1Int)); }
/* 21 */         public float getHealth(int param1Int, float param1Float1, float param1Float2) { return 8.5F + (float)StrictMath.pow(param1Float2 * 10.0D, 1.28D) * 0.042F; }
...
/* 32 */     return WaveTemplates.calculateProbability(paramInt, paramFloat2, 3, 0.07F, 0.5F, 0.33F, -44.0F, 25.0F, 0.11F, 4);
/*    */   }
/*    */   
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\com\prineside\tdi2\waves\templates\IcyHigh.class
