...
/*    */   
/*    */   @NativeType("bool")
/*    */   boolean invoke(@NativeType("extent_hooks_t *") long paramLong1, @NativeType("void *") long paramLong2, @NativeType("size_t") long paramLong3, @NativeType("void *") long paramLong4, @NativeType("size_t") long paramLong5, @NativeType("bool") boolean paramBoolean, @NativeType("unsigned int") int paramInt);
/*    */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\org\lwjgl\system\jemalloc\ExtentMergeI.class
