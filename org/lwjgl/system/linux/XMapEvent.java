...
/*  71 */     OVERRIDE_REDIRECT = layout.offsetof(6);
/*     */   }
/*     */   
/*     */   protected XMapEvent(long paramLong, ByteBuffer paramByteBuffer) {
/*  75 */     super(paramLong, paramByteBuffer);
/*     */   }
/*     */ 
/*     */   
/*     */   protected XMapEvent create(long paramLong, ByteBuffer paramByteBuffer) {
/*  80 */     return new XMapEvent(paramLong, paramByteBuffer);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public XMapEvent(ByteBuffer paramByteBuffer) {
...
/* 114 */     return noverride_redirect(address());
/*     */   }
/*     */   public XMapEvent type(int paramInt) {
/* 117 */     ntype(address(), paramInt); return this;
/*     */   } public XMapEvent serial(@NativeType("unsigned long") long paramLong) {
/* 119 */     nserial(address(), paramLong); return this;
/*     */   } public XMapEvent send_event(@NativeType("Bool") boolean paramBoolean) {
/* 121 */     nsend_event(address(), paramBoolean ? 1 : 0); return this;
/*     */   } public XMapEvent display(@NativeType("Display *") long paramLong) {
/* 123 */     ndisplay(address(), paramLong); return this;
/*     */   } public XMapEvent event(@NativeType("Window") long paramLong) {
/* 125 */     nevent(address(), paramLong); return this;
/*     */   } public XMapEvent window(@NativeType("Window") long paramLong) {
/* 127 */     nwindow(address(), paramLong); return this;
/*     */   } public XMapEvent override_redirect(int paramInt) {
/* 129 */     noverride_redirect(address(), paramInt); return this;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public XMapEvent set(int paramInt1, long paramLong1, boolean paramBoolean, long paramLong2, long paramLong3, long paramLong4, int paramInt2) {
/* 141 */     type(paramInt1);
...
/* 147 */     override_redirect(paramInt2);
/*     */     
/* 149 */     return this;
/*     */   }
/*     */ 
...
/*     */ 
/*     */   
/*     */   public XMapEvent set(XMapEvent paramXMapEvent) {
/* 160 */     MemoryUtil.memCopy(paramXMapEvent.address(), address(), SIZEOF);
/* 161 */     return this;
/*     */   }
/*     */ 
/*     */ 
...
/* 168 */     return new XMapEvent(MemoryUtil.nmemAllocChecked(SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XMapEvent calloc() {
/* 173 */     return new XMapEvent(MemoryUtil.nmemCallocChecked(1L, SIZEOF), null);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XMapEvent create() {
/* 178 */     ByteBuffer byteBuffer = BufferUtils.createByteBuffer(SIZEOF);
/* 179 */     return new XMapEvent(MemoryUtil.memAddress(byteBuffer), byteBuffer);
/*     */   }
/*     */ 
/*     */   
/*     */   public static XMapEvent create(long paramLong) {
/* 184 */     return new XMapEvent(paramLong, null);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public static XMapEvent createSafe(long paramLong) {
/* 190 */     return (paramLong == 0L) ? null : new XMapEvent(paramLong, null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/* 242 */   public static XMapEvent callocStack() { return calloc(MemoryStack.stackGet()); }
/*     */   @Deprecated
/* 244 */   public static XMapEvent mallocStack(MemoryStack paramMemoryStack) { return malloc(paramMemoryStack); }
/*     */   @Deprecated
/* 246 */   public static XMapEvent callocStack(MemoryStack paramMemoryStack) { return calloc(paramMemoryStack); }
/*     */   @Deprecated
...
/*     */ 
/*     */   
/*     */   public static XMapEvent malloc(MemoryStack paramMemoryStack) {
/* 262 */     return new XMapEvent(paramMemoryStack.nmalloc(ALIGNOF, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public static XMapEvent calloc(MemoryStack paramMemoryStack) {
/* 271 */     return new XMapEvent(paramMemoryStack.ncalloc(ALIGNOF, 1, SIZEOF), null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 309 */     return UNSAFE.getInt(null, paramLong + OVERRIDE_REDIRECT);
/*     */   }
...
/* 324 */     UNSAFE.putInt(null, paramLong + OVERRIDE_REDIRECT, paramInt);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     implements NativeResource
/*     */   {
/* 340 */     private static final XMapEvent ELEMENT_FACTORY = XMapEvent.create(-1L);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 352 */       super(param1ByteBuffer, param1ByteBuffer.remaining() / XMapEvent.SIZEOF);
/*     */     }
/*     */     
...
/*     */     
/*     */     public int type() {
/* 374 */       return XMapEvent.ntype(address());
/*     */     } @NativeType("unsigned long")
/*     */     public long serial() {
/* 377 */       return XMapEvent.nserial(address());
/*     */     } @NativeType("Bool")
/*     */     public boolean send_event() {
/* 380 */       return (XMapEvent.nsend_event(address()) != 0);
/*     */     } @NativeType("Display *")
/*     */     public long display() {
/* 383 */       return XMapEvent.ndisplay(address());
/*     */     } @NativeType("Window")
/*     */     public long event() {
/* 386 */       return XMapEvent.nevent(address());
/*     */     } @NativeType("Window")
/*     */     public long window() {
/* 389 */       return XMapEvent.nwindow(address());
/*     */     } public int override_redirect() {
/* 391 */       return XMapEvent.noverride_redirect(address());
/*     */     }
/*     */     public Buffer type(int param1Int) {
/* 394 */       XMapEvent.ntype(address(), param1Int); return this;
/*     */     } public Buffer serial(@NativeType("unsigned long") long param1Long) {
/* 396 */       XMapEvent.nserial(address(), param1Long); return this;
/*     */     } public Buffer send_event(@NativeType("Bool") boolean param1Boolean) {
/* 398 */       XMapEvent.nsend_event(address(), param1Boolean ? 1 : 0); return this;
/*     */     } public Buffer display(@NativeType("Display *") long param1Long) {
/* 400 */       XMapEvent.ndisplay(address(), param1Long); return this;
/*     */     } public Buffer event(@NativeType("Window") long param1Long) {
/* 402 */       XMapEvent.nevent(address(), param1Long); return this;
/*     */     } public Buffer window(@NativeType("Window") long param1Long) {
/* 404 */       XMapEvent.nwindow(address(), param1Long); return this;
/*     */     } public Buffer override_redirect(int param1Int) {
/* 406 */       XMapEvent.noverride_redirect(address(), param1Int); return this;
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Program Files (x86)\Steam\steamapps\common\Infinitode 2\infinitode-2.jar!\org\lwjgl\system\linux\XMapEvent.class
